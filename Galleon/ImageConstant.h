...
#ifndef Galleon_ImageConstant_h
#define Galleon_ImageConstant_h

#define HomePageIcon        [UIImage imageNamed:@"ic_sidebar_homepage"]
#define NewsIcon            [UIImage imageNamed:@"ic_sidebar_news"]
